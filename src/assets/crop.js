 ...
 */
import AF from './alloyfinger'
import TF from './css3transform'
    ; (function () {
        var AlloyFinger = AF
        var Transform = TF
        var AlloyCrop = function (option) {
            ...
            this.arrayBuffer = '' || option.arrayBuffer
            this.rotate = 0
        };
        ...
        AlloyCrop.prototype = {
            init: function () {
                // debugger
                // if (this.arrayBuffer) {
                //     var orientation = this.getOrientation(this.arrayBuffer)
                //     debugger
                //     if (orientation > 1) {
                //         var _parseOrientation = this.parseOrientation(orientation)
                //         this.rotate = _parseOrientation.rotate
                //     }

                // }
                // var rotated = Math.abs(this.rotate) % 180 === 90;
                // this.img_width = rotated ? this.img.height : this.img.width;
                // this.img_height = rotated ? this.img.width : this.img.height;
            ...
            _ok: function () {
                ...
                this.ok(this.canvas.toDataURL("image/" + this.type, this.quality), this.canvas);
            },
